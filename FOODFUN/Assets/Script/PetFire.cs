...
public class PetFire : Pet
{
    ...
    private IEnumerator AttackDelay()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(transform.position + Vector3.up * data.attackY + transform.right * 3, -transform.right, data.attackLength, 512);     
